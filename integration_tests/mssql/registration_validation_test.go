...
func (m *ValidRegistrationModel) QueryByID() string {
	return "SELECT id, name FROM test_registration WHERE id = @p1"
}
...
func (m *InvalidRegistrationModelMissingUniqueQueryBy) QueryByID() string {
	return "SELECT id, email FROM test_registration WHERE id = @p1"
}
...
func TestMSSQL_RegistrationValidation_ValidModel(t *testing.T) {
...
func TestMSSQL_RegistrationValidation_MissingPrimaryQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMSSQL_RegistrationValidation_MissingUniqueQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMSSQL_RegistrationValidation_MissingCompositeQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMSSQL_RegistrationValidation_RegisterModelWithOptions_ValidModel(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMSSQL_RegistrationValidation_RegisterModelWithOptions_InvalidModel(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMSSQL_RegistrationValidation_ValidModelCanBeUsed(t *testing.T) {

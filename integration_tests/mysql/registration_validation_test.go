...
func TestMySQL_RegistrationValidation_ValidModel(t *testing.T) {
...
func TestMySQL_RegistrationValidation_MissingPrimaryQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMySQL_RegistrationValidation_MissingUniqueQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMySQL_RegistrationValidation_MissingCompositeQueryBy(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMySQL_RegistrationValidation_RegisterModelWithOptions_ValidModel(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMySQL_RegistrationValidation_RegisterModelWithOptions_InvalidModel(t *testing.T) {
	// Reset registry for isolated test
	typedb.ResetValidation()
...
func TestMySQL_RegistrationValidation_ValidModelCanBeUsed(t *testing.T) {

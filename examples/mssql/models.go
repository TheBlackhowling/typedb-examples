...
func (p *Profile) QueryByID() string {
	return "SELECT id, user_id, bio, avatar_url, location, website, created_at FROM profiles WHERE id = @p1"
}

func (p *Profile) QueryByUserID() string {
	return "SELECT id, user_id, bio, avatar_url, location, website, created_at FROM profiles WHERE user_id = @p1"
}
...
func (p *Post) QueryByID() string {
	return "SELECT id, user_id, title, content, published, created_at FROM posts WHERE id = @p1"
}
